...
import { LogOut, User, GraduationCap, Shield, Globe, Camera } from 'lucide-react';
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  {hasFace ? (
                    ...
                    <span className="rounded-lg bg-warning/10 px-2 py-1 text-xs text-warning font-medium">Required</span>
                  )}
                </div>
              </div>
            )}
